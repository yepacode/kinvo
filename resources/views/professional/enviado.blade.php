    ...
    <div class="mx-auto max-w-2xl px-4 py-8 sm:px-6">
        ...
        <div class="rounded-2xl border border-line bg-white p-8 text-center sm:p-10">
            ...
            @if ($profile->is_published)
                <h3 class="mt-4 font-serif text-2xl font-medium text-ink">{{ __('Tu perfil está publicado') }}</h3>
                <p class="mt-2 text-sm text-warmgray">{{ __('Los estudios ya pueden encontrarte en la bolsa de talento.') }}</p>
